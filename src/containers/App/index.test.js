...
describe("App", () => {
	...
	describe("componentDidMount", () => {
		...
		it("should pass data fetched to props", () => {
			...
			expect(mockAddSelectedLaunch).toHaveBeenCalledWith(
				mockLaunches.results[0]
			);
		});
	});
